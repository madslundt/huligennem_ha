...
class TestSonosSupport:
    ...
    async def test_resolve_live_sonos_uses_hls_radio_scheme(
        ...
        with patch("custom_components.huligennem.media_source.er.async_get") as mock_er:
    ...
    @pytest.mark.asyncio
    async def test_resolve_live_non_sonos_uses_https(self, media_source: HuligennemMediaSource):
    ...
    @pytest.mark.asyncio
    async def test_resolve_live_no_target_uses_https(self, media_source: HuligennemMediaSource):
    ...
    @pytest.mark.asyncio
    async def test_browse_root_live_uses_channel_class(self, media_source: HuligennemMediaSource):
